...
function header(depth) {
  ...
  <div class="wrap">
    <a class="brand" href="${prefix}index.html" aria-label="${esc(SITE.name)} home">
      <img src="${prefix}assets/logo-header.png" alt="${esc(SITE.name)}">
    </a>
...
<section class="about-way about-way-one">
  <div class="wrap about-way-inner">
    <div>
      <div class="about-label">Way one</div>
...
<section class="about-way about-way-two">
  <div class="wrap about-way-inner">
    <div>
      <div class="about-label">Way two</div>
...
<section class="about-way about-way-three">
  <div class="wrap about-way-inner">
    <div>
      <div class="about-label">Way three</div>
...
<section class="about-closing">
  <div class="wrap">
    ...
    <div class="about-actions">
      ...
      <a class="about-btn about-btn-outline" href="${SITE.instagramUrl}" target="_blank" rel="noopener">Follow @gopherthegoldproductions &#8599;</a>
    </div>
  </div>
</section>
